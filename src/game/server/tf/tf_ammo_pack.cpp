...
//-----------------------------------------------------------------------------
// Purpose: EMP grenade detonates nearby ammo packs.
//          PF2C port — CTFAmmoPack::Explode() from pf2c-src/game/server/tf/tf_ammo_pack.cpp
//-----------------------------------------------------------------------------
static ConVar tf_ammo_pack_explode_damage( "tf_ammo_pack_explode_damage", "65", FCVAR_DEVELOPMENTONLY, "Damage dealt when an ammo pack is detonated by an EMP grenade." );
...
void CTFAmmoPack::Explode( CBaseEntity *pThrower )
{
	...
	float flDamage = tf_ammo_pack_explode_damage.GetFloat();
